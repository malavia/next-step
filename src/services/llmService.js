...
JE VEUX QUE TU ME RENVOI UN UNIQUE TABLEAU JAVASCRIPT. sans texte supplémentaire ni numérotation, pas de Première étape: ou étape 1. PAS DE COMMENTAIRES, pas d'introduction.
Écris chaque étape simplement, sans numéro ni indexation, sous forme de texte séparée dans un seul tableau JavaScript. 
Le tableau doit être formaté comme suit : ["", "", ""].
